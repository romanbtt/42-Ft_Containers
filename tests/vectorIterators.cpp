...
void    testVectorIteratorBegin( bool isStd, std::string ns, bool all )
{
    ...
    if (!all)
    {
		...
		std::cout << "Begin + 1000 of " << ns << " iterator : " << *(vec.begin() + 1000) << std::endl;
        std::cout << std::endl;
    }
    testFile << *(vec.begin()) << "\n";
    testFile << *(vec.begin() + 4) << "\n";
	testFile << *(vec.begin() + 1000) << "\n";
    testFile.close();
    if (isStd == true)
...
void    testVectorIteratorEnd( bool isStd, std::string ns, bool all )
{
    ...
    if (!all)
    {
		...
		std::cout << "End - 1000 of " << ns << " iterator : " << *(vec.end() - 1000) << std::endl;
        std::cout << std::endl;
    }
    testFile << *(vec.end() - 1) << "\n";
    testFile << *(vec.end() - 4) << "\n";
	testFile << *(vec.end() - 1000) << "\n";
    testFile.close();
    if (isStd == true)
...
void    testVectorIteratorRbegin( bool isStd, std::string ns, bool all )
{
    ...
    if (!all)
    {
		...
		std::cout << "Rbegin + 1000 of " << ns << " iterator : " << *(vec.rbegin() + 1000) << std::endl;
        std::cout << std::endl;
    }
    testFile << *(vec.rbegin()) << "\n";
    testFile << *(vec.rbegin() + 4) << "\n";
	testFile << *(vec.rbegin() + 1000) << "\n";
    testFile.close();
    if (isStd == true)
...
void    testVectorIteratorRend( bool isStd, std::string ns, bool all )
{
    ...
    if (!all)
    {
		...
		std::cout << "Rend - 1000 of " << ns << " iterator : " << *(vec.rend() - 1000) << std::endl;
        std::cout << std::endl;
    }
    testFile << *(vec.rend() - 1) << "\n";
    testFile << *(vec.rend() - 4) << "\n";
	testFile << *(vec.rend() - 1000) << "\n";
    testFile.close();
    if (isStd == true)
